...
// Logo WhatsApp sebagai SVG inline. Dipakai tombol pengajuan pembatalan di dua halaman
// (/cancel-order dan /order-cancellation), jadi ditaruh di satu tempat alih-alih disalin dua kali.
//
// `lucide-react` tak menyediakan logo merek, dan memakai ikon "pesan" generik akan membuat tombol
// ini tak langsung dikenali sebagai WhatsApp — padahal justru pengenalan instan itu yang membuat
// pembeli berani menekannya.

// Ikon WhatsApp. Mewarisi warna teks induknya (`fill="currentColor"`).
